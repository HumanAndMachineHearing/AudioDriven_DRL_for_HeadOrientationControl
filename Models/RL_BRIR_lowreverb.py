...
#dir_brir = '/home/wesled/BRIRs_16000Hz'
#dir_brir = '/home/kvanderheij/AudioDriven_RL/Data/BRIRs_16000Hz_smallset'
dir_brir = '/home/kvanderheij/AudioDriven_RL/Data/BRIRs_AudioDriven_RL_lowreverb'
...
# Randomly initiliase weights with state_dict() and copy from policy network to target network to ensure that weights are identical
...
random_sampling_file = os.path.join(dir_random_sampling_file, "random_sampling_file_traindata_brir_lowreverb.txt")
